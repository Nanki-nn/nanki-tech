...
const markdownComponents: Components = {
  ...
  ul: ({ children }: React.ComponentProps<'ul'>) => (
    <ul className="mb-6 list-disc space-y-2 pl-6 text-neutral-700 dark:text-neutral-400">{children}</ul>
  ),
  ol: ({ children }: React.ComponentProps<'ol'>) => (
    <ol className="mb-6 list-decimal space-y-2 pl-6 text-neutral-700 dark:text-neutral-400">{children}</ol>
  ),
